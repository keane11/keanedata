...
> ⚠️ `N8N_BASIC_AUTH_*` 环境变量在 n8n 1.x 中已弃用。如果认证不生效，请到面板 **"设置 → 用户管理"** 创建账号，或查阅 [n8n 官方文档](https://docs.n8n.io)。
...
| **Kimi K2** | ¥2/¥8（以官网为准） | 92/100，偏文学 | 12s | 中 | 长文一致性、长上下文 |
...
```
接单平台：电鸭社区 / 程序员客栈 / v2ex 接单帖 / 私域微信群
典型单价：
...
| 爱发电 | 赞助/订阅 | 开源作者、创作者 |
| 电鸭社区 / 程序员客栈 | 接单 | 技术类接单，有合同保障，质量高于传统威客平台 |
